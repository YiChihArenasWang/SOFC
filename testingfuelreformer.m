...
%% fuel reformer
[LNGflowrate,  H2Oflowrate, unreactedmethaneflowrate, COflowrate, CO2flowrate, H2Ounreactedflowrate, heatdot, H2Ocheckfr, H2fr] = FuelReformer(H2dot);
...
disp(totalmethane);
totalheatfromreformer = sum(heatdot.*dt);
